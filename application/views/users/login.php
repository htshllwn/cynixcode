            ...
            <div class="col-md-6">
                <div class="block">
                    ...
                    <div class="contact-form">
                        <form id="login-form" method="POST" action="<?php echo base_url(); ?>users/login" role="form">
                
                            <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".6s">
                                <input type="text" placeholder="Your Enrollment No." class="form-control" name="enroll" id="enroll">
                            </div>
                            
                            <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".8s">
                                <input type="password" placeholder="Your Password" class="form-control" name="pass" id="pass" >
                            </div>
                            <!--
                            ...
                            <div id="submit" class="wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1.4s">
                                <input type="submit" id="contact-submit" class="btn btn-default btn-send" value="Login">
                            </div>                      
                        </form>
                    </div>
                </div>
