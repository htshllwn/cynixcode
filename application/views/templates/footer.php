<script>
    $(window).load(function() {
		...
		$("#loader").fadeOut("slow");;
            ...
            <footer id="footer">
                <div class="container">
                    <div class="col-md-8">
                        <p class="copyright">Copyright: <span><script>document.write(new Date().getFullYear())</script></span> Developed by <a href="#" target="_blank">CYNIX</a><br> 
                            Get More 
	...
	<!-- slider js -->
	<script src="<?php echo base_url(); ?>assets/plugins/slider/slider.js"></script>
	<!-- Fancybox -->
	<script src="<?php echo base_url(); ?>assets/plugins/facncybox/jquery.fancybox.js"></script>
	<!-- template main js -->
